...
places = {
		...
		"Blair Exclusive Ultra-Chic Lounge": {
		...
		"Center for Higher Study and Philosophy": {
		...
		"Turkish Restaurant, Outdoor Patio": {
		...
		"Premium Texas Instruments Store": {
